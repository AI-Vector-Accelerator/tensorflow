...
std::cout<<"stride  "<<stride_height<<" "<<stride_width<<" "<<std::endl;
    ...
    for (int out_y = 0; out_y < output_height; ++out_y) {
      for (int out_x = 0; out_x < output_width; ++out_x) {
        for (int channel = 0; channel < depth; ++channel) {
          ...
          std::cout<<"filter_y  "<<filter_y_start<<" "<<filter_y_end<<" "<<std::endl;
          std::cout<<"filter_x  "<<filter_x_start<<" "<<filter_x_end<<" "<<std::endl;
          int32_t acc = 0;
          int filter_count = 0;

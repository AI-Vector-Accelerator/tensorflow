...
extern "C" void vectu_dotProduct_offset_stride_vec2(unsigned int N, const uint8_t *vec1, const uint8_t *vec2, int32_t *scalarOut, const int8_t vec1Offset, const int8_t vec2Offset, uint32_t stride);
...
extern "C"  void vect_ReLu6_Bound(unsigned int N, const int8_t *vec1, int8_t *vecOut, int8_t lowerBound, int8_t upperBound);
extern "C"  void vect_ReLu6_Bound_unsigned(unsigned int N, const uint8_t *vec1, uint8_t *vecOut, uint8_t lowerBound, uint8_t upperBound);
